...
namespace YueUltimateDronePhysics
{
    ...
    /// </summary>
    public class PIDFollowEmulator : MonoBehaviour
    {
        [Header("References")]
        [SerializeField]
        ...
        [SerializeField]
        private PidFollowController pidFlightController;
        ...
        void Start()
        {
            ...
            if (pidFlightController == null)
                pidFlightController = GetComponent<PidFollowController>();
        ...
        void Update()
        {
            if (preferPidMissionInputs && pidFlightController != null)
            {
                ...
                inputModule.rawLeftVertical = pidFlightController.OutRawLeftVertical01 * 2f - 1f;
